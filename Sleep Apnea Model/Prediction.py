...
modelw = tf.keras.models.load_model('/home/era/yukkta/apnea.h5/')  #change path here


# In[6]:


X_train = np.load('/home/era/yukkta/train_input.npy', allow_pickle=True)      #change path here
y_train = np.load('/home/era/yukkta/train_label.npy', allow_pickle=True)      #change path here
